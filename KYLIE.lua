...
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."طرد:","دي")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"دي")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."كتم:","اش")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"اش")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."تقيد:","تق")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تق")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."رفع مميز:","م")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."رفع ادمن:","اد")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."رفع مدير:","مد")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."رفع منشئ:","من")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."رفع منشئ اساسي:","اس")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."رفع مطور:","مط")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"مط")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."رفع مطور ثانوي:","ثانوي")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."تعطيل الايدي بالصوره:","تعط")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."تفعيل الايدي بالصوره:","تفع")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."الرابط:","ر")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"ر")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."ردود المدير:","رر")
...
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."مسح رسائلي:","رس")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"رس")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."مسح سحكاتي:","سح")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"سح")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."غنيلي:","غ")
database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"غ")
database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_.."اضف رد:","رد")
