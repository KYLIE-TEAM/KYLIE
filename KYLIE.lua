...
local url,res = https.request('https://KYLIE-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://KYLIE-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
zh = https.request('https://KYLIE-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*✬︙قائمه الزخرفه* \nٴ✬∫ٴ*•━━━━━━ ʙᴏʏ ━━━━━━━•*ٴ✬∫○ٴ \n"
i = 0
...
gk = https.request('https://KYLIE-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://KYLIE-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://KYLIE-api.ml/audios.php')
if res == 200 then
...
{{text = '~ KYLIE •',url='http://t.me/BOBBW'}},
}
...
https.request("https://KYLIE-api.ml/Do/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://KYLIE-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
Ok_id  = DAata:match("(%d+)")  
