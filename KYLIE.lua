...
io.popen("cd library && wget https://raw.githubusercontent.com/KYLIE-DEV/KYLIE/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/KYLIE-DEV/Files_KYLIE/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevKYLIEW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKYLIEW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKYLIEW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKYLIEW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKYLIEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKYLIEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevKYLIEW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1823672541) then  
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@DODDD")  
...
--------------------------------------------------------------------------------------------------------------
function SourceKYLIE(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."KYLIE1:List:Filter"..sl)
...
if not DevKYLIEW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKYLIEW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ✬' and DevKYLIEW(msg) then  
...
if text == 'تعطيل التواصل ✬' and DevKYLIEW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✬' and DevKYLIEW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✬' and DevKYLIEW(msg) then  
...
if text == 'ضع كليشه ستارت ✬' and DevKYLIEW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *꙳.︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✬' and DevKYLIEW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *꙳.︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✬' and DevKYLIEW(msg) then 
...
if text == 'تحديث السورس ✬' and DevKYLIEW(msg) then 
os.execute('rm -rf KYLIE.lua')
os.execute('wget https://raw.githubusercontent.com/KYLIE-DEV/KYLIE/main/KYLIE.lua')
send(msg.chat_id_, msg.id_,' *꙳.︙تم تحديث السورس* \n*꙳.︙لديك اخر اصدار لسورس سناب*\n*꙳.︙الاصدار » { 2.8v}*')
dofile('KYLIE.lua')  
end
if text == 'الاصدار ✬' and DevKYLIEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *꙳.︙اصدار سورس سناب* \n*꙳.︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevKYLIEW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ꙳.︙[تحديثات البوت](t.me/Ppppd) \n꙳.︙[قناه السورس](t.me/Ppppd)')
end
if text == "ضع اسم للبوت ✬" and DevKYLIEW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *꙳.︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✬' and DevKYLIEW(msg) then 
...
if text == 'المشتركين ✬' and DevKYLIEW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *꙳.︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✬' and DevKYLIEW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *꙳.︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✬") and DevKYLIEW(msg) then
...
if text == ("قائمه العام ✬") and DevKYLIEW(msg) then
...
if text == ("قائمه الكتم العام ✬") and DevKYLIEW(msg) then
...
if text=="اذاعه خاص ✬" and msg.reply_to_message_id_ == 0 and DevKYLIEW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *꙳.︙ارسل الان اذاعتك؟* \n*꙳.︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✬" and msg.reply_to_message_id_ == 0 and DevKYLIEW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *꙳.︙ارسل الان اذاعتك؟* \n*꙳.︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✬" and msg.reply_to_message_id_ == 0 and DevKYLIEW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *꙳.︙ارسل الان اذاعتك؟* \n*꙳.︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✬" and msg.reply_to_message_id_ == 0  and DevKYLIEW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *꙳.︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✬" and msg.reply_to_message_id_ == 0  and DevKYLIEW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ꙳.︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✬' and DevKYLIEW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✬" and DevKYLIEW(msg) then
...
if text == "تنظيف الكروبات ✬" and DevKYLIEW(msg) then 
...
if text and text:match("^رفع مطور @(.*)$") and DevKYLIEW(msg) then
...
usertext = '*\n ꙳.︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'Ppppd')..')'
status  = '\n *꙳.︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevKYLIEW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *꙳.︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Ppppd')..')'
status  = '\n*꙳.︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKYLIEW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKYLIEW(msg) then
...
if KYLIE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *꙳.︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ppppd')..') \n ꙳.︙'..KYLIE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKYLIEW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKYLIEW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevKYLIEW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *꙳.︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKYLIEW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *꙳.︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✬" and DevKYLIEW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *꙳.︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✬$") and DevKYLIEW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *꙳.︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✬" and DevKYLIEW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✬" and DevKYLIEW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *꙳.︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✬" and DevKYLIEW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
if t2.id_ then 
name_KYLIE = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_KYLIE then 
names_KYLIE = database:smembers(bot_id.."KYLIE:blocname"..msg.chat_id_) or ""
if names_KYLIE and names_KYLIE[1] then 
for i=1,#names_KYLIE do 
if name_KYLIE:match("(.*)("..names_KYLIE[i]..")(.*)") then 
...
function amir_KYLIEa_new(KYLIE1,KYLIE2)
if KYLIE2 and KYLIE2.first_name_ then 
if KYLIE2.first_name_:match("(.*)"..database:get(bot_id.."KYLIE:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KYLIE:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local KYLIE_nnn = database:get(bot_id.."KYLIE:nump"..msg.chat_id_) or 5
local KYLIE_nnn2 = database:get(bot_id.."KYLIE:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(KYLIE_nnn2) == tonumber(KYLIE_nnn) or tonumber(KYLIE_nnn2) > tonumber(KYLIE_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KYLIE:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "꙳.︙عزيزي >>["..KYLIE2.username_.."](https://t.me/"..(KYLIE2.username_ or "Ppppd")..")\n꙳.︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KYLIE:teh"..msg.chat_id_).."} بجانب اسمك\n꙳.︙عدد المحاولات المتبقيه {"..(tonumber(KYLIE_nnn) - tonumber(KYLIE_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_KYLIEa_new)
end
end
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝙏𝙚𝘼𝙢 𝙆𝙮𝙡𝙞𝙚\n\n[✬  ѕɴᴀʙ ᴄʜᴀɴɴᴇʟ](http://t.me/Ppppd)\n\n[✬  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/Ppppd)\n\n[✬  ѕɴᴀʙ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/DODDD)\n\n[✬  ʙᴏᴛ ѕɴᴀʙ](http://t.me/GGY6FBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'رفع نسخه الاحتياطيه' and DevKYLIEW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevKYLIEW(msg) then
dofile('KYLIE.lua')  
send(msg.chat_id_, msg.id_, ' *꙳.︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevKYLIEW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKYLIEW(msg) then  
function start_function(extra, result, success)
if KYLIESudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevKYLIEW(msg) then  
...
if KYLIESudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*꙳.︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevKYLIEW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if KYLIESudoBot(userid) then
send(msg.chat_id_, msg.id_,"*꙳.︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKYLIEW(msg) then  
function start_function(extra, result, success)
if KYLIESudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*꙳.︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevKYLIEW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevKYLIEW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if KYLIESudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*꙳.︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKYLIEW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevKYLIEW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevKYLIEW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevKYLIEW(msg) then
...
if text == 'الملفات' and DevKYLIEW(msg) then
t = ' *꙳.︙ملفات السورس سناب ↓*\n*•━━━━━━ 𝙎𝘽 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevKYLIEW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/KYLIE-DEV/Files_KYLIE/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevKYLIEW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/KYLIE-DEV/Files_KYLIE/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevKYLIEW(msg) then
...
if text == "مسح الملفات" and DevKYLIEW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *꙳.︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKYLIEW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKYLIEW(msg) then  
function start_function(extra, result, success)
...
if text == 'مسح كليشه المطور' and DevKYLIEW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *꙳.︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevKYLIEW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *꙳.︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'Ppppd')..')'..'\n*꙳.︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKYLIEW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevKYLIEW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevKYLIEW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,KYLIE)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n"
x = 0
...
if KYLIESudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevKYLIEW(msg) then 
...
if text == ("ردود المطور") and DevKYLIEW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ꙳.︙قائمة ردود المطور \n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKYLIEW(msg) then    
send(msg.chat_id_, msg.id_,' *꙳.︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevKYLIEW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سناب').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevKYLIEW(msg) then   
...
if text == 'تعطيل المغادره' and DevKYLIEW(msg) then  
...
if text == 'استعاده الاوامر' and DevKYLIEW(msg) then
...
{{text = '꙳. 𝙏𝙚𝘼𝙢 𝙆𝙮𝙡𝙞𝙚', url="t.me/Ppppd"}},
{{text = 'مطور السورس', url="t.me/DODDD"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ✬∫ٴ*•━━━━━━ 𝙎𝘽 ━━━━━━━•*ٴ✬∫○ٴ\n꙳.︙[꙳. 𝙏𝙚𝘼𝙢 𝙆𝙮𝙡𝙞𝙚](t.me/Ppppd) ')
end
...
inline = {
{{text = '𝙏𝙚𝘼𝙢 𝙆𝙮𝙡𝙞𝙚',url='http://t.me/Ppppd'}},
}
